...
2. **MACRO Keys:**
    ...
    - `**{{pick A|B|C}}**`: `You better choose {{pick A|B|C}} section` -> `You better choose B section` - Random Choice out of 2+ Options. Supports only `{{roll}}` nesting - `{{pick {{roll 1d6}}|{{roll 2d6}}|{{roll 3d6}}}}`.
