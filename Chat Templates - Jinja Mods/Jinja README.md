...
- Faster Web Search without thinking, since it is a simple sum task.
- Simple `thinking` phase activation just by adding `/think` anywhere in the System Prompt, by hand or by Lorebook script.

## How to use.
- llama.cpp: just add `--chat-template-file D:\Gemma-4-26-31b-VASCURA-Mod.jinja` to the launching parameters.
